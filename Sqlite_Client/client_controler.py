...
class Controller:
    ...
    def __init__(self, root):
        ...
        self.objeto_vista = cliente_vista.Ventana(self.root_controler)
        self.root_controler.protocol("WM_DELETE_WINDOW", self.on_closing)
    
    def on_closing(self):
        cliente_vista.Ventana.aviso(self.objeto_vista, self.root_controler)
    ...
    def aviso_ac(root_tk):
        ...
        while True:
            ...
            if data == "_ac":
                objeto_vista = cliente_vista.Ventana(root_tk)
